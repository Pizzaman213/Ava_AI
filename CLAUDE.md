...
**Benchmarking**: Always benchmark performance before and after making changes to training code, kernels, or optimizations. Compare tokens/second, memory usage, and throughput to ensure changes provide measurable improvements. Log all benchmark results for tracking.
