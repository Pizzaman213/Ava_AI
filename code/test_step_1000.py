#!/usr/bin/env python3
"""Test the LLM checkpoint at step 1000"""
...
def test_checkpoint():
    checkpoint_path = '/project/code/outputs/runs/run_20251016_112832_40d4999d/checkpoints/step_1000/model.pt'

    print("=" * 80)
    print("Testing LLM Checkpoint at Step 1000")
    print("=" * 80)
    ...
    # Filter out parameters not accepted by EnhancedMoEConfig
    import inspect
