...
Usage:
    from ava.logging.console.colored import setup_pipeline_logging, PipelineLogger
    ...
    from ava.logging.console.colored import setup_colored_logging, print_header
...
def setup_pipeline_logging(
    ...
    Example:
        ...
        from ava.logging.console.colored import setup_pipeline_logging
