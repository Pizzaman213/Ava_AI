...
This directory contains all loss functions for the Ava AI training pipeline, unified into a single, flexible system.

## Files

### Core Loss Module
- **[unified_loss.py](unified_loss.py)** - Main unified loss class combining all components (RECOMMENDED)

### Individual Loss Components
- **[deepseek_loss.py](deepseek_loss.py)** - DeepSeek-style losses (temperature-scaled CE, MTP, MoE balancing)
- **[adaptive_mtp_loss.py](adaptive_mtp_loss.py)** - Adaptive multi-token prediction with confidence weighting
- **[repetition_penalty_loss.py](repetition_penalty_loss.py)** - N-gram and immediate repetition penalties
- **[anti_repetition_loss.py](anti_repetition_loss.py)** - Anti-repetition loss with adaptive penalties
- **[advanced_losses.py](advanced_losses.py)** - Advanced losses (focal, contrastive, diversity, auxiliary, etc.)
