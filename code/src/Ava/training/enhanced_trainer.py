...
from .gradient_surgery import AdaptiveGradientSurgeon, GradientSurgeon
from .lr_manager import IntelligentLRManager, LRConfig
from .memory_monitor import MemoryMonitor
from .metrics import MetricConfig, TrainingMetricsCollector
from .performance_modes import PerformanceModeConfig, PerformanceModeManager
from .rank_aware_error_handler import (
    ErrorSeverity,
    ErrorType,
...
class EnhancedModularTrainer:
    ...
    def _init_performance_manager(self):
        ...
        from .performance_modes import PerformanceMode, PerformanceModeConfig
